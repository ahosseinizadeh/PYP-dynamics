...
nS = 143703;               % # of snapshots AFTER concatenation (# of chronos)  
...
shareDir = '/home/username/PYP/dataY/';
% local directory on the remote cluster:
localDir = '/home/username/PYP/';  
logfile_template = [shareDir 'reconstruct_%d_of_' num2str(numTasks) '.log'];
dataSVD = [localDir,'SVD_results_sigma540.00.mat'];
